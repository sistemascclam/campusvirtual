...
export default function header() {
    ...
    <button type="button" className="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
      <img src="public/images/cclamlogotipo.png">
          </img>
       </button>
                      
           <button type="button">
               <div className="text-white hover:text-white block px-20 py-2 rounded-md text-base font-medium">Categorias
             </div>
             </button>
      ...
      <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
        ...
        <input type="text" id="inputSearch" placeholder="Buscar en campus CCLAM">
