...
export default function Curso(){
    ...
    const   data  = useSWR(`/api/public/curso_id/${keyword}`, (...args) => fetch(...args).then(res => res.json())) 
    console.log(data)
                    ...
                    <div className='lg:flex xl:flex'>
                        ...
                        <div className="bg-darkblue text-white lg:w-1/2  p-4 w-full">
                            <div className='py-2 px-3 '>
                                ...
                                <span className='text-3xl font-semibold'>{keyword} Aprende Javascript ES9, HTML, 
                                CSS3 y NodeJS desde cero</span>
                                <span className='text-slate-100 py-5 block'>  
                                Aprende a programar con Javascript sin conocimiento
