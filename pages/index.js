      ...
      <div className="min-h-screen text-white w-full">
        ...
        }
        {
          status !== 'loading' && session && arrayDashboard ?
            <div className="grid grid-cols-2 md:grid-cols-3 justify-center py-3 gap-3 md:gap-x-6 max-w-5xl mx-auto" >
              ...
              <div className='bg-slate-900 rounded-xl shadow-lg p-3 md:px-6 md:py-4 col-span-2 md:col-span-1'>
                <div className='flex gap-6 justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="hidden md:block h-20 w-20 text-blue-800" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
