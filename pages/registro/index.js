                        ...
                        <div className="w-full max-w-xs mx-auto">
                            <form onSubmit={handleSubmit} onKeyPress={resetError} className="rounded pt-4 ">
                                <div className="mb-4">
                                    ...
                                    <input onChange={(e) => setformData({ ...formData, email: e.target.value })} type="text" id="username" placeholder="ejm@gmail.com" autoComplete='off' className="shadow bg-gray-900 hover:bg-darkblue appearance-none border rounded w-full text-sm py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" />
                                </div>
                                <div className="mb-6">
                                    <div className='py-1'>
