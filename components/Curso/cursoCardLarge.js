...
export default function CursoCardLarge({ Curso }) {
    ...
    return (
        <div className="box-border rounded-2xl bg-slate-900 h-full text-white shadow-xl">
            <Link href={"/curso/" + Curso.ruta}>
                <a className='w-full flex flex-col md:flex-row'>
                    ...
                    <div className='w-full md:w-9/12 pl-5 py-2 md:py-6'>
                        <div className='my-2'>
                        ...
                        <div className='flex items-center'>
                            <span className='text-base flex text-amber-400'>
                        ...
                        <div className='py-3 flex flex-col'>
                            ...
                            <span className='text-base'>S/.{Curso.price?.toFixed(2)}</span>
                        </div>
                    </div>
                </a>
            </Link>
